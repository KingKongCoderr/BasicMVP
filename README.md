Basic Andriod project using MVP design pattern with model sending data using callback methods this project also includes Junit test class for Model written using Mockito,RoboElectric
